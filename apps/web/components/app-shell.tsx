...
import {
  ChartPieSlice, Cube, FlagBanner, Gear, ListChecks, SignOut
    ...
    <div className="min-h-dvh md:grid md:grid-cols-[15rem_1fr]">
      <aside className="hidden border-r border-[var(--line)] bg-[var(--surface)] p-5 md:flex md:flex-col">
        ...
        <div className="mt-auto border-t border-[var(--line)] pt-5">
          <p className="truncate text-sm font-medium">个人工作区</p>
          <p className="mt-1 truncate text-xs text-[var(--muted)]">仅管理员可访问</p>
